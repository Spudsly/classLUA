...
return {
   Barbie = {
      -- Barbie theme matched to MQ2SmartLoot palette (dark base + pink accents)
      Text = { 1.00, 0.95, 0.98, 1.00, },
      TextDisabled = { 0.70, 0.55, 0.65, 1.00, },

      WindowBg = { 0.07, 0.05, 0.08, 0.98, },
      ChildBg = { 0.10, 0.07, 0.12, 1.00, },
      PopupBg = { 0.09, 0.07, 0.10, 0.95, },

      -- Frames and controls
      FrameBg = { 0.20, 0.10, 0.18, 1.00, },
      FrameBgHovered = { 0.55, 0.14, 0.45, 1.00, },
      FrameBgActive = { 0.70, 0.20, 0.55, 1.00, },

      -- Title and headers
      TitleBg = { 0.12, 0.06, 0.14, 1.00, },
      TitleBgActive = { 0.55, 0.14, 0.45, 1.00, },
      TitleBgCollapsed = { 0.12, 0.06, 0.14, 0.70, },
      Header = { 0.45, 0.10, 0.35, 0.60, },
      HeaderHovered = { 0.70, 0.20, 0.55, 0.85, },
      HeaderActive = { 0.85, 0.25, 0.65, 1.00, },

      -- Tabs & menu
      MenuBarBg = { 0.12, 0.08, 0.14, 1.00, },
      Tab = { 0.45, 0.10, 0.35, 0.75, },
      TabHovered = { 0.70, 0.20, 0.55, 1.00, },
      TabActive = { 0.60, 0.18, 0.48, 0.85, },
      TabUnfocused = { 0.20, 0.12, 0.22, 0.85, },
      TabUnfocusedActive = { 0.38, 0.16, 0.32, 0.85, },

      -- Buttons
      -- Muted buttons (less fuchsia/bright pink)
      Button = { 0.62, 0.24, 0.50, 0.70, },
      ButtonHovered = { 0.74, 0.34, 0.62, 0.90, },
      ButtonActive = { 0.56, 0.26, 0.50, 0.95, },

      -- Tables
      TableHeaderBg = { 0.18, 0.08, 0.16, 1.00, },
      TableRowBg = { 0.00, 0.00, 0.00, 0.00, },
      TableRowBgAlt = { 1.00, 0.90, 0.95, 0.06, },

      -- Accent/Indicators
      CheckMark = { 0.95, 0.25, 0.70, 1.00, },
      SliderGrab = { 0.95, 0.25, 0.70, 1.00, },
      SliderGrabActive = { 0.85, 0.15, 0.60, 1.00, },

      -- Reasonable defaults for other ImGui colors (derived from palette)
      Border = { 0.30, 0.18, 0.28, 0.50, },
      BorderShadow = { 0.00, 0.00, 0.00, 0.00, },
      ScrollbarBg = { 0.10, 0.10, 0.10, 0.20, },
      ScrollbarGrab = { 0.45, 0.10, 0.35, 1.00, },
      ScrollbarGrabHovered = { 0.70, 0.20, 0.55, 1.00, },
      ScrollbarGrabActive = { 0.60, 0.18, 0.48, 1.00, },
      Separator = { 0.30, 0.18, 0.28, 0.60, },
      SeparatorHovered = { 0.70, 0.20, 0.55, 0.80, },
      SeparatorActive = { 0.85, 0.25, 0.65, 0.90, },
      ResizeGrip = { 0.45, 0.10, 0.35, 0.54, },
      ResizeGripHovered = { 0.70, 0.20, 0.55, 0.66, },
      ResizeGripActive = { 0.85, 0.25, 0.65, 0.80, },
      PlotLines = { 0.85, 0.25, 0.65, 1.00, },
      PlotLinesHovered = { 0.95, 0.35, 0.75, 1.00, },
      PlotHistogram = { 0.95, 0.25, 0.70, 1.00, },
      PlotHistogramHovered = { 0.98, 0.40, 0.80, 1.00, },
      TextSelectedBg = { 0.95, 0.25, 0.70, 0.25, },
      DragDropTarget = { 1.00, 1.00, 0.00, 0.90, },
      NavHighlight = { 0.95, 0.25, 0.70, 0.50, },
      NavWindowingHighlight = { 1.00, 1.00, 1.00, 0.70, },
      NavWindowingDimBg = { 0.10, 0.10, 0.10, 0.20, },
      ModalWindowDimBg = { 0.07, 0.05, 0.08, 0.60, },
   },
   Magellan = {
