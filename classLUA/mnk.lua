...
local combatActions = {
    { type = "skill", name = "Tiger Claw" },
    { type = "disc", name = "Fists of Wu" },
    { type = "aa", name = "Zan Fi's Whistle" },
    { type = "skill", name = "Kick" },
    { type = "skill", name = "Flying Kick" },
    { type = "disc", name = "Dragon Fang" },
    { type = "disc", name = "Innerflame Discipline" },
    { type = "aa", name = "Five Point Palm" },
}

local chestClickies = {
    "Leather Vest of the Blightclaw Stalker",
    "Leather Vest of Ragnar Fjordason",
    "Leather Vest of Dorvias N",
}

local combatBuffClickies = {
    {
        name = "Crab Fu: The Way of the Quickening Fists",
        buff = "Crab Fu: The Way of the Quickening Fists",
    },
}
...
local function useRightwristClicky()
    ...
    if (mq.TLO.Me.Buff("Cloak of Mitigation").Duration() or 0) >= 300000 then return false end
...
local function doSelfBuffs()
    ...
    -- Fists of Wu
    if (mq.TLO.Me.Song("Fists of Wu").ID() or 0) == 0 then
        mq.cmd("/disc Fists of Wu")
        mq.delay(50)
    end
